...
public class ItemBlockPorte extends ItemBlock {
	
	public ItemBlockPorte(Block block) {
		super(block);
		this.setMaxDamage(0);
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		if(metadata < 0 || metadata >= BlockPorte.subBlock.length)
			metadata = 0;
		
		return super.getUnlocalizedName() + "." + BlockPorte.subBlock[metadata];
	}
}