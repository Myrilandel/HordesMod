...
public class TileEntityChantierFondations extends TileEntity {
	...
	public int PATroisièmeCouche = ChantiersRegistry.recetteTroisiemeCouche[ChantiersRegistry.recetteTroisiemeCouche.length-1];
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
    	...
    	this.PATroisièmeCouche = compound.getInteger("PATroisièmeCouche");
    ...
    public void writeToNBT(NBTTagCompound compound)
    {
    	...
    	compound.setInteger("PATroisièmeCouche", this.PATroisièmeCouche);
	...
	public void decreasePATroisièmeCouche() {this.PATroisièmeCouche--;updateTileEntity();}
