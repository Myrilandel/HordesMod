...
public class BlockToSouth extends Block{

	private int newMotion = 0;

	public BlockToSouth(Material material) {
		super(material);
		this.setBlockName("BlockToSouth");
		this.setBlockTextureName(HordeMod.MODID + ":blockToSouth");
