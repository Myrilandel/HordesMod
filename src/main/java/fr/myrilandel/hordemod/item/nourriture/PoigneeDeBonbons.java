...
public class PoigneeDeBonbons extends ItemFood {

	public PoigneeDeBonbons() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("PoigneeDeBonbons");
		this.setTextureName(HordeMod.MODID + ":poigneeDeBonbons");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.poigneeDeBonbons);
