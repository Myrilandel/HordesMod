...
public class PaquetDeChipsMolles extends ItemFood {

	public PaquetDeChipsMolles() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("PaquetDeChipsMolles");
		this.setTextureName(HordeMod.MODID + ":paquetDeChipsMolles");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.paquetDeChipsMolles);
