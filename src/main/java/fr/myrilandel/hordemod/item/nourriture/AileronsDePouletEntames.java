...
public class AileronsDePouletEntames extends ItemFood {

	public AileronsDePouletEntames() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("AileronsDePouletEntames");
		this.setTextureName(HordeMod.MODID + ":aileronsDePouletEntames");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.aileronsDePouletEntames);
