...
public class PureeDeCharognardes extends ItemFood {

	public PureeDeCharognardes() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("PureeDeCharognardes");
		this.setTextureName(HordeMod.MODID + ":pureeDeCharognardes");
...
ExtendedEntityPropEtats entityPropPA = ExtendedEntityPropEtats.get(entityPlayer);
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.pureeDeCharognardes);
