...
public class SteakAppetissant extends ItemFood {

	public SteakAppetissant() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("SteakAppetissant");
		this.setTextureName(HordeMod.MODID + ":steakAppetissant");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.steakAppetissant);
