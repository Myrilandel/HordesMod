...
public class PetitBeurresRances extends ItemFood {

	public PetitBeurresRances() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("PetitBeurresRances");
		this.setTextureName(HordeMod.MODID + ":petitBeurresRances");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.petitBeurresRances);
