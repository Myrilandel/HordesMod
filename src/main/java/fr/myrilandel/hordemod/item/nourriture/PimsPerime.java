...
public class PimsPerime extends ItemFood {

	public PimsPerime() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("PimsPerime");
		this.setTextureName(HordeMod.MODID + ":pimsPerime");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.pimsPerime);
