...
public class NouillesChinoisesEpicees extends ItemFood {

	public NouillesChinoisesEpicees() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("NouillesChinoisesEpicees");
		this.setTextureName(HordeMod.MODID + ":nouillesChinoisesEpicees");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.nouillesChinoisesEpicees);
