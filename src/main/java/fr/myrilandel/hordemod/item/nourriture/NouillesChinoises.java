...
public class NouillesChinoises extends ItemFood {

	public NouillesChinoises() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("NouillesChinoises");
		this.setTextureName(HordeMod.MODID + ":nouillesChinoises");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.nouillesChinoises);
