...
public class NapolitainsMoisis extends ItemFood {

	public NapolitainsMoisis() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("NapolitainsMoisis");
		this.setTextureName(HordeMod.MODID + ":napolitainsMoisis");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.napolitainsMoisis);
