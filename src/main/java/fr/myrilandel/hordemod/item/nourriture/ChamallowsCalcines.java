...
public class ChamallowsCalcines extends ItemFood {

	public ChamallowsCalcines() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("ChamallowsCalcines");
		this.setTextureName(HordeMod.MODID + ":chamallowsCalcines");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.chamallowsCalcines);
	...
	public void onCreated(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		entityPlayer.inventory.addItemStackToInventory(new ItemStack(HMItemRegistry.torche));
	}
