...
public class SteakDeSciure extends ItemFood {

	public SteakDeSciure() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("SteakDeSciure");
		this.setTextureName(HordeMod.MODID + ":steakDeSciure");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.steakDeSciure);
