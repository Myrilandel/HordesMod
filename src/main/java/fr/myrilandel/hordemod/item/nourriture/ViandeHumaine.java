...
public class ViandeHumaine extends ItemFood {

	public ViandeHumaine() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("ViandeHumaine");
		this.setTextureName(HordeMod.MODID + ":viandeHumaine");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.viandeHumaine);
