...
public class MelonDIntestin extends ItemFood {

	public MelonDIntestin() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("MelonDIntestin");
		this.setTextureName(HordeMod.MODID + ":melonDIntestin");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.melonDIntestin);
