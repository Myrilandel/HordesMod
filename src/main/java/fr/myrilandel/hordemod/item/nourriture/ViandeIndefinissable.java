...
public class ViandeIndefinissable extends ItemFood {

	public ViandeIndefinissable() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("ViandeIndefinissable");
		this.setTextureName(HordeMod.MODID + ":viandeIndefinissable");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.viandeIndefinissable);
