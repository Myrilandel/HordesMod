...
public class ChewingGumsSeches extends ItemFood {

	public ChewingGumsSeches() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("ChewingGumsSeches");
		this.setTextureName(HordeMod.MODID + ":chewingGumsSeches");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.chewingGumsSeches);
