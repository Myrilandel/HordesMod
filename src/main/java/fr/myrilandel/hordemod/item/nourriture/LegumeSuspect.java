...
public class LegumeSuspect extends ItemFood {

	public LegumeSuspect() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("LegumeSuspect");
		this.setTextureName(HordeMod.MODID + ":legumeSuspect");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.legumeSuspect);
