...
public class JambonBeurreMoisi extends ItemFood {

	public JambonBeurreMoisi() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("JambonBeurreMoisi");
		this.setTextureName(HordeMod.MODID + ":jambonBeurreMoisi");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.rassasie) {
				entityPropPA.setPA(SourcesDePA.jambonBeurreMoisi);
