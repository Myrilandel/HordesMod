...
public class CidreClavicepsArtisanal extends ItemFood {

	public CidreClavicepsArtisanal() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("CidreClavicepsArtisanal");
		this.setTextureName(HordeMod.MODID + ":cidreClavicepsArtisanal");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.ivre && !entityPropPA.gueuleDeBois) {
				entityPropPA.setPA(SourcesDePA.cidreClavicepsArtisanal);
