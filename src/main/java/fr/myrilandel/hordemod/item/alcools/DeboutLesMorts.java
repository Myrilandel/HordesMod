...
public class DeboutLesMorts extends ItemFood {

	public DeboutLesMorts() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("DeboutLesMorts");
		this.setTextureName(HordeMod.MODID + ":deboutLesMorts");
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer) {
		...
		if(!world.isRemote)
			if(!entityPropPA.ivre && !entityPropPA.gueuleDeBois) {
				entityPropPA.setPA(SourcesDePA.deboutLesMorts);
