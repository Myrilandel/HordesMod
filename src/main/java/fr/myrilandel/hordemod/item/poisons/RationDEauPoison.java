...
public class RationDEauPoison extends ItemFood {

	public RationDEauPoison() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("RationDEauPoison");
		this.setTextureName(HordeMod.MODID + ":rationDEauPoison");
