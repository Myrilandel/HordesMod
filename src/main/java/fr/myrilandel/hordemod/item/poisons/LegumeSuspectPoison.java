...
public class LegumeSuspectPoison extends ItemFood {

	public LegumeSuspectPoison() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("LegumeSuspectPoison");
		this.setTextureName(HordeMod.MODID + ":legumeSuspectPoison");
