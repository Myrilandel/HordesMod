...
public class BoiteDeConserveOuvertePoison extends ItemFood {

	public BoiteDeConserveOuvertePoison() {
		super(10, 0.0F, false);
		this.setAlwaysEdible();
		this.setUnlocalizedName("BoiteDeConserveOuvertePoison");
		this.setTextureName(HordeMod.MODID + ":boiteDeConserveOuvertePoison");
