...
public class BoiteDeJeu extends Item{
	private static final Item item0 = HMItemRegistry.des;
	private static final Item item1 = HMItemRegistry.jeuDeCartes;
	Item[] tabItemRand = {item0, item1};

	public BoiteDeJeu() {
		this.setUnlocalizedName("BoiteDeJeu");
		this.setTextureName(HordeMod.MODID + ":boiteDeJeu");
