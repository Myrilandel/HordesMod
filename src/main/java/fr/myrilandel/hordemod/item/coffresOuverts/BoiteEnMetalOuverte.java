...
public class BoiteEnMetalOuverte extends Item {

	private static final Item item0 = HMItemRegistry.bandageRudimentaire;
	private static final Item item1 = HMItemRegistry.boiteDAllumettes;
	private static final Item item2 = HMItemRegistry.deboutLesMorts;
	private static final Item item3 = HMItemRegistry.explosifsBruts;
	private static final Item item4 = HMItemRegistry.steroidesAnabolisants;
	private static final Item item5 = HMItemRegistry.twinoides500Mg;
	private static final Item item6 = HMItemRegistry.vodkaMarinostov;
	Item[] tabItemRand = {item0, item1, item2, item3, item4, item5, item6};

	public IIcon[] icons = new IIcon[5];
	public BoiteEnMetalOuverte() {
		this.setHasSubtypes(true);
		this.setMaxDamage(0);
		this.setUnlocalizedName("BoiteEnMetalOuverte");
		this.setTextureName(HordeMod.MODID + ":boiteEnMetalOuverte");
	...
	public void registerIcons(IIconRegister reg) {
	    for (int i = 0; i < icons.length; i ++) {
	        this.icons[i] = reg.registerIcon(HordeMod.MODID + ":boiteEnMetalOuverte");
	    }
	}
