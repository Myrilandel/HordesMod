...
public class EntityBombeAEauExplosive extends EntityThrowable {

	public EntityBombeAEauExplosive(World world) {
		super(world);
	}	

	public EntityBombeAEauExplosive(World world, EntityLivingBase entity) {
		super(world, entity);
	}	
	
	protected void onImpact(MovingObjectPosition mvObjPos) {
		this.createExplosion(null, this.posX, this.posY, this.posZ, 2.0F, false);
